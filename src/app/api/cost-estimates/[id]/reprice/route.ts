...
export async function POST(
  ...
  try {
    ...
    const calculationResult = await calculateEstimate(boqLines, {
      ...
      equipmentRateEdition: baseEstimate.equipmentRateEdition || '',
      equipmentRateMode: baseEstimate.equipmentRateMode || 'fixed',
      fuelPricePerLiter: baseEstimate.fuelPricePerLiter || 0,
      lubePricePerLiter: baseEstimate.lubePricePerLiter || 0,
