...
export const AUDITOR_ROLE: UserRole = 'auditor';
...
export const PROJECT_READ_ROLES: UserRole[] = [MASTER_ADMIN_ROLE, ADMIN_ROLE, PROJECT_CREATOR_ROLE, AUDITOR_ROLE];
...
export const DUPA_READ_ROLES: UserRole[] = [MASTER_ADMIN_ROLE, ADMIN_ROLE, PROJECT_CREATOR_ROLE, AUDITOR_ROLE];
...
export const AUDIT_READ_ROLES: UserRole[] = [MASTER_ADMIN_ROLE, ADMIN_ROLE, PROJECT_CREATOR_ROLE, AUDITOR_ROLE];
export const AUDIT_WRITE_ROLES: UserRole[] = [MASTER_ADMIN_ROLE, ADMIN_ROLE, AUDITOR_ROLE];
